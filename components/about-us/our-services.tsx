        ...
        <div className="flex flex-col md:flex-row items-start gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 mb-6 font-brother">
              ...
              à l'héliport de Monaco et dans tous les terminaux de l'Aéroport Nice Côte d'Azur.
            </p>

            <ul className="list-disc pl-6 mb-6 text-gray-600 space-y-2 font-brother">
              <li>
                Prise en charge des passagers, y compris l'embarquement/débarquement et la gestion
                des bagages.
              </li>
