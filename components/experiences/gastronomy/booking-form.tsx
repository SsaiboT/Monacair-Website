        ...
        <div className="bg-white rounded-lg p-8 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-2">
              ...
              <Select defaultValue="diner-etoile">
                <SelectTrigger className="w-full">
                  <SelectValue placeholder={t('flightDetails.selectExperience')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="diner-etoile">{t('experiences.dinner')}</SelectItem>
                  <SelectItem value="degustation">{t('experiences.wine')}</SelectItem>
                  <SelectItem value="cuisine">{t('experiences.cooking')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
